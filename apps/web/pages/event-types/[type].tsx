...
const EventTypePage = (props: inferSSRProps<typeof getServerSideProps>) => {
  ...
  const defaultLocations = [
    ...
    { value: LocationType.Twilio, label: "Twilio" },
  ];
  ...
  const LocationOptions = () => {
    ...
    switch (selectedLocation.value) {
      ...
      case LocationType.Twilio:
        return <p className="text-sm">{t("cal_provide_twilio_meeting_url")}</p>;
      default:
        return null;
    }
  };
            ...
            {formMethods.getValues("locations").map((location) => (
              <li
                ...
                <div className="flex justify-between">
                  ...
                  {location.type === LocationType.Twilio && (
                    <div className="flex flex-grow items-center">
                      <svg
                        width="1.25em"
                        height="1.25em"
                      ...
                      <span className="text-sm ltr:ml-2 rtl:mr-2">Twilio</span>
                    </div>
                  )}
